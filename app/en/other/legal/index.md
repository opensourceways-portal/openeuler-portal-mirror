...
1. Service scope: We may provide you with generative artificial intelligence (AI) services (hereinafter referred to as "the Services") through various means, including but not limited to web pages, desktop clients, mini‑programs, browser extensions, and any other forms that may emerge with technological advancements. The specifics shall be determined by the official releases published by us.

2. Service purpose: The content generated by the Services is produced by the large language model (LLM) and does not represent the position of the service provider. Where such content may have significant impact on you or related parties, it shall not be construed as a substitute for advice from qualified professionals. Such content is provided for reference only. You shall bear full legal responsibility for any judgment made or subsequent actions taken in reliance on the generated content. Please use the Services with caution, rationally, and in compliance with applicable laws.

3. During your use of the Services, if we identify that you have the intention to search the internet or you have proactively selected the internet search function, we will automatically search for public information from third-party websites through non-manual means in order to enhance our responses to you. We will also display the search source and relevant content when responding. You acknowledge that the content and information (such as web pages) displayed in the search source are provided by third parties. The outputs of the Services are the intelligent integration of such information based on the natural language processing capabilities of the LLM. Although the sources are indicated, inaccuracies may still exist. This does not constitute an endorsement by the service provider of the positions and opinions expressed in either the source information or the generated responses. You are advised to exercise your own judgment and discretion in assessing such content.

4. When using the Services, you shall comply with applicable laws, administrative regulations, and regulatory provisions, including but not limited to the Criminal Law of the People's Republic of China, Cybersecurity Law of the People's Republic of China, Data Security Law of the People's Republic of China, Personal Information Protection Law of the People's Republic of China, Administrative Measures for Internet Information Services, Provisions on the Administration of Deep Synthesis for Internet Information Services, and Interim Measures for the Administration of Generative Artificial Intelligence Services. Once you use the Services, you undertake that you shall not:
  ...
  (3) Copy, disclose, distribute, sell, rent, or lease the Services to any third party, or use the Services for commercial purposes, except as expressly authorized by this Agreement or a separate agreement for a specific Service.

  (4) Breach, circumvent, bypass, or disable any security protection measures, content protection mechanism, authentication mechanism, digital copyrights management, or data measurement tool of this platform.

  (5) Abuse, disrupt, or utilize this platform for any unauthorized use, or attempt to access areas not intended for user access, or upload any malicious software (such as viruses, logic bombs, worms, Trojan horses, traps, backdoors, or other software of such nature) to servers of this platform, or otherwise interfere with the normal operation of the Services.
...
5. Any information you provide when using the Services must be either your own property or information you are authorized by the relevant rights holders to use. Such information shall not infringe upon the intellectual property rights, portrait rights, reputation rights, honor rights, privacy rights, personal information rights, or any other legitimate rights and interests of any person, nor shall it involve any national secrets, trade secrets, critical data, or any other data that may compromise national security or public interests. Otherwise, you shall assume full responsibility for all risks and liabilities arising from such infringement. You shall also be liable for all direct and indirect losses (including but not limited to economic losses, goodwill losses, rights protection expenses, and attorney fees) suffered by us as a result.

6. To fulfill legal compliance requirements, we reserve the right to take technical or manual measures to review your use of the Services and related information, including but not limited to reviewing input and output, establishing risk filtering mechanisms, and building illegal content feature libraries.

7. Upon publication or dissemination of outputs generated by the Services, you shall:

  (1) Verify the authenticity and accuracy of such content to prevent the dissemination of false information;

  (2) Clearly indicate that such content is generated by AI to inform the public of its synthetic nature;

  (3) Refrain from publishing or disseminating any content that violates the provisions of this Legal Notice.

8. If you illegally use the Services to fabricate or spread false information, we will retain relevant records in accordance with applicable laws and report to the cybersecurity department and relevant competent authorities.

9. To the extent permitted by law, you own all rights, title, and interest in and to the generated content (excluding generated content based on example input provided by the Services) created through your use of the Services based on the input you provide, and you are solely responsible for such generated content. You hereby grant us a worldwide, perpetual, free, irrevocable, non-exclusive, sublicensable license to reproduce, use, publicly display, distribute, and modify such generated content.

10. Due to the nature of machine learning, you acknowledge that the generated content you create using the Services may be identical or substantially similar to generated content created by other users using the same services. You further acknowledge that the generated content requested and created for other users does not belong to you.

11. The generated content you create using the Services may contain links or information from third-party websites or services. These websites or services are not owned or controlled by us. You acknowledge and agree that we are not liable for any third-party websites or services. Please carefully review the terms of service, privacy policies, and other applicable agreements of any third-party websites or services that you visit or use.
